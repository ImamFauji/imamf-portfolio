...
const Services = () => {
  return (
    ...
    >
      ...
      >
        My services include web development, app development, and UI/UX design. I
        can help you with your project from start to finish.
      </motion.p>
      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          hover:shadow-md shadow-lg cursor-pointer hover:bg-lightHover 
