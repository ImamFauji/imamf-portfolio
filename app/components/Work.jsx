  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-center max-w2-xl mx-auto mt-5 mb-12 font-Ovo"
      >
        My latest work and some of the projects I've worked on. I'm always
        looking for new opportunities to learn and grow.
      </motion.p>

      {/* Still Bug when White/Sun Mode */}
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
      ...
      <motion.a
       ...
       border-[0.5px] rounded-full py-3 px-10 mx-auto 
      my-20 hover:bg-gray-200 duration-500 dark:shadow-md dark:hover:bg-gray-300 dark:hover:shadow-white"
      >
        Show more
        <Image
          src={
